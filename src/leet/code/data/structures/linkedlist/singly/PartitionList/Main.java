package leet.code.data.structures.linkedlist.singly.PartitionList;

public class Main {

    public static void main(String[] args) {
        PartitionList myLinkedList;

        // Test 1: Empty list
        System.out.println("Test 1: Empty List");
        myLinkedList = new PartitionList(1);
        ...
        myLinkedList = new PartitionList(5);
        myLinkedList.partitionList(3);
        ...
        myLinkedList = new PartitionList(3);
