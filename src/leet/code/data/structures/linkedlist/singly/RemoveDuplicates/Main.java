package leet.code.data.structures.linkedlist.singly.RemoveDuplicates;

public class Main {

        public static void main(String[] args) {
            RemoveDuplicatesLinkedList myLinkedList;

            // Test 1: Empty list
            System.out.println("Test 1: Empty List");
            myLinkedList = new RemoveDuplicatesLinkedList(1);
            ...
            myLinkedList = new RemoveDuplicatesLinkedList(10);
            myLinkedList.removeDuplicates();
            ...
            myLinkedList = new RemoveDuplicatesLinkedList(5);
