...
public class Main {
    ...
    private static void printForward(PartitionListDLL dll) {
        PartitionListDLL.Node current = dll.getHead();
        if (current == null) {
    ...
    private static void printBackward(PartitionListDLL dll) {
        PartitionListDLL.Node current = dll.getHead();
        if (current == null) {
