package leet.code.data.structures.linkedlist.doubly.Reverse;

public class Main {


    // Helper to print forward traversal
    private static void printForward(ReverseDLL dll) {
        ReverseDLL.Node current = dll.getHead();
        if (current == null) {
    ...
    private static void printBackward(ReverseDLL dll) {
        ReverseDLL.Node current = dll.getTail();
        if (current == null) {
