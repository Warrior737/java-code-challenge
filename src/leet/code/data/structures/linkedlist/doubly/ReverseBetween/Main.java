...
public class Main {
    ...
    private static void printForward(ReverseBetweenDLL dll) {
        ReverseBetweenDLL.Node current = dll.getHead();
        if (current == null) {
    ...
    private static void printBackward(ReverseBetweenDLL dll) {
        ReverseBetweenDLL.Node current = dll.getHead();
        if (current == null) {
