package leet.code.data.structures.linkedlist.doubly.SwapNodesInPairs;

public class Main {

    private static void printForward(SwapNodesInPairs dll) {
        SwapNodesInPairs.Node current = dll.getHead();
        if (current == null) {
    ...
    private static void printBackward(SwapNodesInPairs dll) {
        SwapNodesInPairs.Node current = dll.getHead();
        if (current == null) {
