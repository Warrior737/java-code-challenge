package leet.code.data.structures.linkedlist.doubly.PalindromeChecker;

public class Main {

    public static void main(String[] args) {
        PalindromeChecker myList;

        // Test 1: Empty list
        System.out.println("Test 1: Empty List");
        myList = new PalindromeChecker(1);
        myList.makeEmpty();
        ...
        myList = new PalindromeChecker(10);
        ...
        myList = new PalindromeChecker(5);
        myList.append(5);
        System.out.print("List: ");
        myList.printList();
        System.out.println("Expected: true");
